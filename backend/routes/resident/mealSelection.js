...
const MealSelection = require("../../models/resident/mealSelection"); // Import the model
const MealsCount = require("../../models/resident/mealCount");

const router = express.Router();

// POST endpoint for saving meal selection
router.post("/save-meal-selection", async (req, res) => {
  const {
    residentname,
    residentId,
    selectedDay,
